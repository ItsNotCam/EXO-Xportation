  ...
  connectedCallback() {
    ...
    <nav id="nav-container"
      ...
      <a href="/" class="
        cch 
        fixed left-4 
        aldrich text-custom-light-100 text-3xl
      ...
      <ul id="nav-main" class="nav-links" data-expanded="false">
				<li id="display-name-list" class="display-name hidden nav:flex">
					...
					<p class="inline text-exo-light-300 username"></p>
				</li>
        ...
        <li><a href="journey.html" class="nav-link cch" data-active='${path.replace("_b", "").endsWith("/journey.html")}'>JOURNEY</a></li>
        <li><a href="book.html" class="nav-link cch" data-active='${path.endsWith("/book.html")}'>BOOK A FLIGHT</a></li>
        <li><a href="about.html" class="nav-link cch" data-active='${path.endsWith("/about.html")}'>ABOUT</a></li>
        <li><a href="inspiration.html" class="nav-link cch" data-active='${path.endsWith("/inspiration.html")}'>INSPO</a></li>
        ...
        <svg width="35px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" stroke="#eee" stroke-width=".6" fill="rgba(0,0,0,0)" stroke-linecap="round" style="cursor: pointer">
          ...
          <rect width="10" height="10" stroke="none">
			...
			<div id="display-name-full" class="display-name absolute top-7 right-7 flex nav:hidden">
				<p class="username inline text-exo-light-300"></p>
				<button>
					<svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="18px" fill="#e8eaed">
						<path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/>
					</svg>
