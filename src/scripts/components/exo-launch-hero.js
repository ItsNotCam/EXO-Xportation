...
class ExoLaunchHero extends HTMLElement {
  constructor() {
    ...
    <div class="flex flex-col gap-2 ${textAlign} rounded-xl max-[1024px]:rounded-sm p-4 bg-fade-in  anim-delay-4 bg-blend-multiply">
      ...
      <p class="mb-2 max-w-[35rem] slide-fade-in  anim-delay-3">
