...
class ExoBtn extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = /*html*/ `
    <button class="
    	${isLight ? " btn-angled-light" : "" } cch relative w-max grid items-center grid-cols-1 grid-rows-1 transition-colors duration-200 text-exo-light-100 hover:text-exo-dark-500 ">
