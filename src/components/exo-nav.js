  ...
  connectedCallback() {
    ...
    <nav class="fixed w-full flex flex-col gap-4 items-center justify-center py-9 z-50" data-expanded="false">
      ...
      <ul id="nav-main" class="nav-links" data-expanded="false">
        ...
        <li><a href="flights.html" class="nav-link cch" data-active='${path.endsWith("/flights.html") ? "true" : "false" }'>FLIGHTS</a></li>
        <li><a href="journey.html" class="nav-link cch" data-active='${path.endsWith("/journey.html") ? "true" : "false" }'>JOURNEY</a></li>
        <li><a href="mission.html" class="nav-link cch" data-active='${path.endsWith("/about.html") ? "true" : "false" }'>ABOUT</a></li>
        <li class="hidden flex-row gap-4 justify-end items-center mt-auto mb-4 border-none nav:flex">
          <a class="cch group w-[25px]" href="https://www.figma.com/design/wM1QwepxhQEqXILXFCVqTv/IT-331-Project-1?node-id=0-1&t=lRgPOmWjdUkPz3k1-1" target="_blank">
          ...
          <a class="cch group w-[25px]" href="https://github.com/ItsNotCam/EXO-Xportation" target="_blank">
      ...
      <button id="nav-dropdown-button" class="cch hidden absolute top-4 right-4 z-10 nav:block">
